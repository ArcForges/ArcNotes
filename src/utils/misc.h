...
void openFolderSelect(const QString& absolutePath, const QString& questionDialogIdentifier = QString());
...
bool startDetachedProcess(const QString& executablePath, const QStringList& parameters = QStringList(),
                          QString workingDirectory = QLatin1String(""));
bool openFilesWithApplication(const QString& executablePath, const QStringList& files = QStringList(),
                              QString workingDirectory = QLatin1String(""));
...
QByteArray startSynchronousProcess(const QString& executablePath, const QStringList& parameters,
                                   const QByteArray& data = QByteArray(), const QString& workingDirectory = "");
...
QString prepareDebugInformationLine(const QString& headline, QString data, bool withGitHubLineBreaks = true,
