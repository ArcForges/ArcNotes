...
internal sealed class MainWindow : Window
{
    ...
    public MainWindow(HelloViewModel state)
    {
        ...
        contents.Children.Add(new TextBlock { Text = "ARCFORGES / ARCNOTES", Foreground = Brush.Parse("#305E46"), FontWeight = FontWeight.Bold, LetterSpacing = 1 });
