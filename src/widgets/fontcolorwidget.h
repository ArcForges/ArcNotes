...
public:
    explicit FontColorWidget(QWidget* parent = nullptr, SettingsViewModel* settingsViewModel = nullptr);
...
private:
    FontColorControls* _controls = nullptr;
    QStringList _defaultSchemaKeys;
    QString _currentSchemaKey;
    bool _currentSchemaIsDefault = false;
