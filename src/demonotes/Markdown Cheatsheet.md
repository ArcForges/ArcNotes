...
This cheatsheet is intended as a quick reference and showcase of the markdown syntax in [ArcNotes](https://www.arcnotes.org).
...
Tables aren't part of the core Markdown spec, but the ArcNotes preview supports them.
