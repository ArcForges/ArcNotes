...
void NoMenuIconStyle::drawControl(ControlElement element, const QStyleOption* option, QPainter* painter,
...
QPixmap NoMenuIconStyle::generatedIconPixmap(QIcon::Mode iconMode, const QPixmap& pixmap,
    ...
    const QColor disabledColor = opt ? opt->palette.color(QPalette::Disabled, QPalette::ButtonText)
