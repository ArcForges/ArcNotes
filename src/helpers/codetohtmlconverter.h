...
private:
    ...
    Q_REQUIRED_RESULT static int highlightStringLiterals(StringView input, QChar strType, QString& output, int i);
    Q_REQUIRED_RESULT static int highlightComment(StringView input, QString& output, int i, bool isSingleLine = true);
    Q_REQUIRED_RESULT static int highlightWord(int i, const LangData& data, StringView input, QString& output,
                                               Format f);
    Q_REQUIRED_RESULT QString xmlHighlighter(StringView input) const;
    Q_REQUIRED_RESULT QString cssHighlighter(StringView input, const LangData& types, const LangData& keywords) const;
